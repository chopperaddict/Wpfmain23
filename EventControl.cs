...
namespace Views
{
	...
	public class EventControl
    {
        ...
        {
            Debug. WriteLine($"DEBUG : In EventControl : Sending  ViewSharingChanged EVENT trigger from {e . Sender}");
        ...
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  ForceEditDbIndexChanged EVENT trigger" );
        ...
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  ViewerIndexChanged EVENT trigger (from {obj?.ToString ( )})" );
        ...
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  MultiViewerIndexChanged EVENT trigger (from{obj?.ToString ( )})" );
        ...
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  TriggerBackgroundBankDataLoaded EVENT trigger" );
        ...
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  TriggerBackgroundCustDataLoaded EVENT trigger" );
        ...
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  TriggerBackgroundDetDataLoaded EVENT trigger" );
        ...
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  CustDataLoaded EVENT trigger (from{obj ?. ToString ( )})" );
            if ( CustDataLoaded != null )
                CustDataLoaded?.Invoke(obj , e);
        }
        public static void TriggerDetDataLoaded (object obj , LoadedEventArgs e)
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  DetDataLoaded EVENT trigger (from{obj? . ToString ( )})" );
            if ( DetDataLoaded != null )
                DetDataLoaded?.Invoke(obj , e);
        }
        public static void TriggerGenDataLoaded (object obj , LoadedEventArgs e)
        {
            //			Debug. WriteLine ( $"DEBUG : In EventControl : Sending  GenDataLoaded EVENT trigger (from{obj? . ToString ( )})" );
        ...
        public static void TriggerRecordDeleted (object obj , LoadedEventArgs e)
        {
            ...
            Debug. WriteLine($"DEBUG : In EventControl : Sending  RecordDeleted  EVENT trigger");
        }
